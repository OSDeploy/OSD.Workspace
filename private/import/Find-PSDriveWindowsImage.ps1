function Find-PSDriveWindowsImage {
    ...
    Write-Verbose "[$(Get-Date -format G)] [$($MyInvocation.MyCommand.Name)] Found $($WindowsMediaDrives.Count) PSDrives"
    ...
    if ($WindowsMediaSources) {
        Write-Verbose "[$(Get-Date -format G)] [$($MyInvocation.MyCommand.Name)] Returning WindowsMediaSources"
        return $WindowsMediaSources
    }
    else {
        Write-Verbose "[$(Get-Date -format G)] [$($MyInvocation.MyCommand.Name)] No WindowsMediaSources"
        return $null
    }
    #endregion
    #=================================================
