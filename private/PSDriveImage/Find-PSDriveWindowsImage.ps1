function Find-PSDriveWindowsImage {
    ...
    Write-Verbose "[$((Get-Date).ToString('HH:mm:ss'))][$($MyInvocation.MyCommand)] Found $($WindowsMediaDrives.Count) PSDrives"
    ...
    if ($WindowsMediaSources) {
        Write-Verbose "[$((Get-Date).ToString('HH:mm:ss'))][$($MyInvocation.MyCommand)] Returning WindowsMediaSources"
        return $WindowsMediaSources
    }
    else {
        Write-Verbose "[$((Get-Date).ToString('HH:mm:ss'))][$($MyInvocation.MyCommand)] No WindowsMediaSources"
        return $null
    }
    #endregion
    #=================================================
