...
'@
    #=================================================
    Write-Host -ForegroundColor DarkGray "[$(Get-Date -format G)] [$($MyInvocation.MyCommand.Name)] Modifying WinPE CMD and PowerShell Console settings"
    Write-Verbose "[$(Get-Date -format G)] [$($MyInvocation.MyCommand.Name)] This increases the buffer and sets the window metrics and default fonts"
